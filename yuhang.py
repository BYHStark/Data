...
def clickbutton1():
    ...
    neirong = [percentage(perslot[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1]),
               percentage(per5[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1]),
               percentage(per10[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1]),
               percentage(per20[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1]),
               percentage(perall[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1])]
    biaotou = {'人数占比': neirong[0], '前五机台占比': neirong[1], '前十机台占比': neirong[2],
               '前二十机台占比': neirong[3], '所有机台占比': neirong[4]}
    df = pd.DataFrame(biaotou)
    df.to_excel(id + 'SPIN人数.xlsx', index=False)
...
def clickbutton2():
    ...
    neirong = [percentage(perslot[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1]),
               ...
               percentage(per20[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1]),
               percentage(perall[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1])]
    biaotou = {'总SPIN次数占比': neirong[0], '前五机台占比': neirong[1], '前十机台占比': neirong[2],
               '前二十机台占比': neirong[3], '所有机台占比': neirong[4]}
    df = pd.DataFrame(biaotou)
    df.to_excel(id + '总SPIN次数.xlsx', index=False)
...
def clickbutton3():
    ...
    neirong = [slot[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1],
               per5[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1],
               per10[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1],
               per20[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1],
               perall[length(riqi, date_start, date_end)[0]:length(riqi, date_start, date_end)[1] + 1]]
    biaotou = {'单机台平均SPIN': neirong[0], '前五机台平均SPIN': neirong[1], '前十机台平均SPIN': neirong[2],
               '前二十机台平均SPIN': neirong[3], '所有机台平均SPIN': neirong[4]}
    df = pd.DataFrame(biaotou)
    df.to_excel(id + '平均SPIN次数.xlsx', index=False)
...
def clickbutton4():
    ...
    biaotou = {'总SPIN次数占比': neirong[0], '前五机台占比': neirong[1], '前十机台占比': neirong[2],
               '前二十机台占比': neirong[3], '所有机台占比': neirong[4]}
    df = pd.DataFrame(biaotou)
    df.to_excel(id + '金币消耗.xlsx', index=False)
